...
local menu = game:GetObjects("rbxassetid://9888829302")[1]
...
menu.outline.outline.main.text.Text = "cuteware.shit"
...
function library:saveConfig()
    ...
    writefile("cuteware.shit/"..name..".cfg",game:GetService("HttpService"):JSONEncode(jig))
...
function library:loadConfig()
    ...
    if not isfile("cuteware.shit/"..name..".cfg") then
        library:notify("Config file not found!")
        return
    end
    local config = game:GetService("HttpService"):JSONDecode(readfile("cuteware.shit/"..name..".cfg"))
...
function library:refreshConfigs()
    local tbl = {}
    for i,v in next, listfiles("cuteware.shit/") do
...
function library:deleteConfig()
    if isfile("cuteware.shit/"..library.flags["selected_config"]..".cfg") then
        delfile("cuteware.shit/"..library.flags["selected_config"]..".cfg")
        library:refreshConfigs()
    end
end
